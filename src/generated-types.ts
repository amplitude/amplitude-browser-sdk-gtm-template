...
export interface GeneratedGtmParameters {
  ...
  groupName: string;
  setDeviceId: string;
  trackGroup?: {eventType?: string; eventProperties?: Array<{name: string; value: string}>; eventPropertiesObject?: string; trackTimestamp?: string; trackWithGroups?: boolean; trackEventGroups?: Array<{eventGroupType: string; eventGroupName: string}>};
  eventType: string;
  eventProperties?: Array<{name: string; value: string}>;
  eventPropertiesObject?: string;
  ...
  identifyGroup?: {identifyGroupType?: string; identifyGroupName?: string; userPropertyOperations?: Array<{command: 'set' | 'setOnce' | 'add' | 'append' | 'prepend' | 'remove' | 'preInsert' | 'postInsert' | 'clearAll' | 'unset'; userProperty: string; value: string}>; userPropertyOperationsObject?: string};
  ...
  userPropertyOperationsObject?: string;
