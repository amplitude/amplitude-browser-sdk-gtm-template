...

{
  ...
  "description": "The tag utilizes the Amplitude Browser SDK 2.0 for data collection. Check the Breaking Changes List \u003ca herf\u003d\"https://www.docs.developers.amplitude.com/data/sources/google-tag-manager-client\"\u003ehere\u003c/a\u003e.",
  "containerContexts": [
    "WEB"
  ]
}
