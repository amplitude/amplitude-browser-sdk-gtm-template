...

{
  ...
  "description": "Template for Amplitude Analytics. The tag utilizes the Amplitude \u003ca herf\u003d\"https://www.docs.developers.amplitude.com/data/sdks/browser-2/\"\u003eBrowser SDK 2.0\u003c/a\u003e for data collection.",
  "containerContexts": [
    "WEB"
  ]
}
