...

{
  ...
  "description": "The tag utilizes the Amplitude Browser SDK 2.0 for data collection. Check the \u003cStrong\u003eBreaking Change List \u003c/Strong\u003e \u003ca herf\u003d\"data/sources/google-tag-manager-client/#breaking-change\"\u003ehere\u003c/a\u003e.",
  "containerContexts": [
    "WEB"
  ]
}
