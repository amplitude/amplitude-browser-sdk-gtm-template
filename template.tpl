...

{
  ...
  "description": "Template for Amplitude Analytics. The tag utilizes the Amplitude Marketing Analytics Browser SDK for data collection.",
  "containerContexts": [
    "WEB"
  ]
}
